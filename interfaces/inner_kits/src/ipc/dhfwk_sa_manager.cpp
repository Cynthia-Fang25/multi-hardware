...
DHFWKSAManager::DHFWKSAManager()
    : dhfwkOnLine_(false), isSubscribeDHFWKSAChangeListener_(false), dhfwkProxy_(nullptr),
      saListener_(new SystemAbilityListener()), saStateCallback_(nullptr),
...
DHFWKSAManager::~DHFWKSAManager()
{
    ...
    dhfwkOnLine_ = false;
    isSubscribeDHFWKSAChangeListener_ = false;
    dhfwkProxy_ = nullptr;
    saListener_ = nullptr;
}
...
void DHFWKSAManager::RegisterAbilityListener()
{
    ...
    if (!isSubscribeDHFWKSAChangeListener_) {
        ...
        isSubscribeDHFWKSAChangeListener_ = true;
    }
}
