...
public:
    ...
    virtual int32_t RegisterPrivacyResources(std::shared_ptr<PrivacyResourcesListener> listener);
    virtual int32_t PauseDistributedHardware(const std::string &networkId);
    virtual int32_t ResumeDistributedHardware(const std::string &networkId);
    virtual int32_t StopDistributedHardware(const std::string &networkId);
};
