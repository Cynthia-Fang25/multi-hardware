...
int32_t WriteClockUnitToMemory(AVTransSharedMemory &memory, AVSyncClockUnit &clockUnit)
{
...
int32_t ReadClockUnitFromMemory(AVTransSharedMemory &memory, AVSyncClockUnit &clockUnit)
{
